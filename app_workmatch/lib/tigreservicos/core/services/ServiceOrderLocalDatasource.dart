import 'package:app_workmatch/tigreservicos/core/services/DatabaseHelper.dart';
import 'package:app_workmatch/tigreservicos/core/services/ServiceOrder.dart';
import 'package:sqflite/sqflite.dart';

class ServiceOrderLocalDataSource {
  final DatabaseHelper _dbHelper = DatabaseHelper.instance;

  ServiceOrderLocalDataSource(DatabaseHelper databaseHelper);
